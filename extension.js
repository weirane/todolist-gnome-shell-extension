...
// TodoList class
let TodoList = GObject.registerClass(class TodoList extends PanelMenu.Button {
    _init() {
    ...
    _enable() {
        ...
        let mode =
            Shell.ActionMode ? Shell.ActionMode.ALL : Shell.KeyBindingMode.ALL;
        this.monitor = fileM.monitor(Gio.FileMonitorFlags.NONE, null);
        this.monitor.connect('changed', Lang.bind(this, this._refresh));

        // Key binding
        Main.wm.addKeybinding(
            'open-todolist', ExtensionSettings, Meta.KeyBindingFlags.NONE, mode,
